...
namespace Saklient.Cloud.Resources
{
    ...
    public class CommonServiceItem : Resource
    {
        ...
        public override string _ClassName() => "CommonServiceItem";
        ...
        /// </summary>
        public CommonServiceItem Save() => ((CommonServiceItem)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public CommonServiceItem Reload() => ((CommonServiceItem)(this._Reload()));
        ...
        private CommonServiceProvider Get_provider() => this.M_provider;

        /// <summary>共通サービスプロバイダ情報
        /// </summary>
        public CommonServiceProvider Provider => this.Get_provider();
        ...
        private object Get_rawStatus() => this.M_rawStatus;

        /// <summary>ステータスの生データ
        /// </summary>
        public object RawStatus => this.Get_rawStatus();
