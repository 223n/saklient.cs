...
namespace Saklient.Cloud.Resources
{
    ...
    public class Ipv6Net : Resource
    {
        ...
        public override string _ClassName() => "Ipv6Net";
        ...
        private string Get_prefix() => this.M_prefix;

        /// <summary>ネットワークプレフィックス
        /// </summary>
        public string Prefix => this.Get_prefix();

        private bool N_prefixLen = false;

        private long? Get_prefixLen() => this.M_prefixLen;

        /// <summary>ネットワークプレフィックス長
        /// </summary>
        public long? PrefixLen => this.Get_prefixLen();

        private bool N_prefixTail = false;

        private string Get_prefixTail() => this.M_prefixTail;

        /// <summary>このネットワーク範囲における最後のIPv6アドレス
        /// </summary>
        public string PrefixTail => this.Get_prefixTail();
