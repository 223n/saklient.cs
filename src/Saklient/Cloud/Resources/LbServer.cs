...
namespace Saklient.Cloud.Resources
{
    ...
    public class LbServer
    {
        ...
        public bool? Get_enabled() => this._Enabled;
        ...
        public string Get_ipAddress() => this._IpAddress;
        ...
        public long? Get_port() => this._Port;
        ...
        public string Get_protocol() => this._Protocol;
        ...
        public string Get_pathToCheck() => this._PathToCheck;
        ...
        public long? Get_responseExpected() => this._ResponseExpected;
        ...
        public long Get_activeConnections() => this._ActiveConnections;

        /// <summary>現在の接続数
        /// </summary>
        public long ActiveConnections => this.Get_activeConnections();

        internal string _Status;

        public string Get_status() => this._Status;
