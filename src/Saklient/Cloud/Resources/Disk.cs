...
namespace Saklient.Cloud.Resources
{
    ...
    public class Disk : Resource
    {
        ...
        internal override string _ApiPath() => "/disk";

        internal override string _RootKey() => "Disk";

        internal override string _RootKeyM() => "Disks";

        public override string _ClassName() => "Disk";
        ...
        /// </summary>
        public Disk Save() => ((Disk)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Disk Reload() => ((Disk)(this._Reload()));

        internal DiskActivity _Activity;

        public DiskActivity Get_activity() => this._Activity;

        /// <summary>アクティビティ
        /// </summary>
        public DiskActivity Activity => this.Get_activity();
        ...
        internal bool Get_isAvailable() => this.Get_availability() == EAvailability.AVAILABLE;
        ...
        public Resource Get_source() => this._Source;
        ...
        /// </summary>
        public DiskConfig CreateConfig() => new DiskConfig(this._Client, this._Id());
        ...
        private long? Get_sizeMib() => this.M_sizeMib;

        private long? Set_sizeMib(long? v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Disk#Set_sizeMib");
            this.M_sizeMib = v;
            this.N_sizeMib = true;
        ...
        private DiskPlan Get_plan() => this.M_plan;

        private DiskPlan Set_plan(DiskPlan v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Disk#Set_plan");
            this.M_plan = v;
            this.N_plan = true;
            return this.M_plan;
        }
        ...
        private Server Get_server() => this.M_server;

        /// <summary>接続先のサーバ
        /// </summary>
        public Server Server => this.Get_server();
