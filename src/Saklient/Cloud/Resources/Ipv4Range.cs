...
namespace Saklient.Cloud.Resources
{
    ...
    public class Ipv4Range
    {
        ...
        public string Get_first() => this._First;

        /// <summary>開始アドレス
        /// </summary>
        public string First => this.Get_first();

        internal string _Last;

        public string Get_last() => this._Last;

        /// <summary>終了アドレス
        /// </summary>
        public string Last => this.Get_last();
        ...
        /// </summary>
        public System.Collections.Generic.List<string> AsArray => this.Get_asArray();
