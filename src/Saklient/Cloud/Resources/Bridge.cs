...
namespace Saklient.Cloud.Resources
{
    ...
    public class Bridge : Resource
    {
        ...
        public override string _ClassName() => "Bridge";
        ...
        /// </summary>
        public Bridge Save() => ((Bridge)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Bridge Reload() => ((Bridge)(this._Reload()));
        ...
        private Region Get_region() => this.M_region;

        private Region Set_region(Region v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Bridge#Set_region");
            this.M_region = v;
            this.N_region = true;
