...
namespace Saklient.Cloud.Resources
{
    ...
    public class Archive : Resource
    {
        ...
        internal override string _ApiPath() => "/archive";

        internal override string _RootKey() => "Archive";

        internal override string _RootKeyM() => "Archives";

        public override string _ClassName() => "Archive";
        ...
        /// </summary>
        public Archive Save() => ((Archive)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Archive Reload() => ((Archive)(this._Reload()));
        ...
        public FtpInfo Get_ftpInfo() => this._FtpInfo;

        /// <summary>FTP情報
        /// </summary>
        public FtpInfo FtpInfo => this.Get_ftpInfo();

        internal override void _OnAfterApiDeserialize(object r, object root)
        {
            if (root != null && (root as System.Collections.Generic.Dictionary<string, object>).ContainsKey("FTPServer"))
            {
        ...
        internal override void _OnAfterApiSerialize(object r, bool withClean)
        {
            ...
            if (this._Source != null)
            {
                ...
                else if (this._Source._ClassName() == "Disk")
                {
                    object s = withClean ? this._Source.ApiSerialize(true) : new System.Collections.Generic.Dictionary<string, object> { { "ID", this._Source._Id() } };
        ...
        private string Get_scope() => this.M_scope;

        /// <summary>スコープ <see cref="Saklient.Cloud.Enums.EScope" />
        /// </summary>
        public string Scope => this.Get_scope();
        ...
        private long? Get_displayOrder() => this.M_displayOrder;
        ...
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Archive#Set_sizeMib");
            this.M_sizeMib = v;
            this.N_sizeMib = true;
        ...
        /// <summary>プラン
        /// </summary>
        public DiskPlan Plan => this.Get_plan();
