...
namespace Saklient.Cloud.Resources
{
    ...
    public class Ipv4Net : Resource
    {
        ...
        public Ipv4Range Get_range() => this._Range;

        /// <summary>利用可能なIPアドレス範囲
        /// </summary>
        public Ipv4Range Range => this.Get_range();

        internal override string _ApiPath() => "/subnet";

        internal override string _RootKey() => "Subnet";

        internal override string _RootKeyM() => "Subnets";

        public override string _ClassName() => "Ipv4Net";
        ...
        internal override void _OnAfterApiDeserialize(object r, object root)
        {
            ...
            if (addresses != null) this._Range = new Ipv4Range(addresses);
        }
        ...
        private string Get_address() => this.M_address;

        /// <summary>ネットワークアドレス
        /// </summary>
        public string Address => this.Get_address();

        private bool N_maskLen = false;

        private long? Get_maskLen() => this.M_maskLen;

        /// <summary>マスク長
        /// </summary>
        public long? MaskLen => this.Get_maskLen();

        private bool N_defaultRoute = false;

        private string Get_defaultRoute() => this.M_defaultRoute;

        /// <summary>デフォルトルート
        /// </summary>
        public string DefaultRoute => this.Get_defaultRoute();

        private bool N_nextHop = false;

        private string Get_nextHop() => this.M_nextHop;

        /// <summary>ネクストホップ
        /// </summary>
        public string NextHop => this.Get_nextHop();
