...
namespace Saklient.Cloud.Resources
{
    ...
    public class Server : Resource
    {
        ...
        public override string _ClassName() => "Server";
        ...
        /// </summary>
        public Server Save() => ((Server)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Server Reload() => ((Server)(this._Reload()));

        internal ServerActivity _Activity;

        public ServerActivity Get_activity() => this._Activity;

        /// <summary>アクティビティ
        /// </summary>
        public ServerActivity Activity => this.Get_activity();
        ...
        {
            if (r != null) this._Activity.SetSourceId(this._Id());
        }

        /// <summary>サーバが起動しているときtrueを返します。
        /// </summary>
        public bool IsUp() => this.Get_instance().IsUp();

        /// <summary>サーバが停止しているときtrueを返します。
        /// </summary>
        public bool IsDown() => this.Get_instance().IsDown();
        ...
        /// </summary>
        public bool SleepUntilUp(long timeoutSec = 180) => this.SleepUntil(EServerInstanceStatus.UP, timeoutSec);
        ...
        /// </summary>
        public bool SleepUntilDown(long timeoutSec = 180) => this.SleepUntil(EServerInstanceStatus.DOWN, timeoutSec);
        ...
        private ServerPlan Get_plan() => this.M_plan;

        private ServerPlan Set_plan(ServerPlan v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Server#Set_plan");
            this.M_plan = v;
            this.N_plan = true;
            return this.M_plan;
        }
        ...
        private ServerInstance Get_instance() => this.M_instance;

        /// <summary>インスタンス情報
        /// </summary>
        public ServerInstance Instance => this.Get_instance();
