...
namespace Saklient.Cloud.Resources
{
	...
	public class Activity
	{
        ...
        internal virtual string _ApiPathPrefix() => null;

        internal virtual string _ApiPathSuffix() => "/monitor";

        internal virtual void _AddSample(string atStr, object data)
		{
		}

        public Activity(Client client) => this._Client = client;

        public void SetSourceId(string id) => this._SourceId = id;
        ...
        public Activity _Fetch(System.DateTime? startDate=null, System.DateTime? endDate=null)
		{
			...
			for (int __it1=0; __it1 < dates.Count; __it1++) {
