...
namespace Saklient.Cloud.Resources
{
    ...
    public class CommonServiceProvider : Resource
    {
        ...
        internal override string _ApiPath() => "/commonserviceprovider";

        internal override string _RootKey() => "CommonServiceProvider";

        internal override string _RootKeyM() => "CommonServiceProviders";

        public override string _ClassName() => "CommonServiceProvider";
        ...
        /// <summary>クラス <see cref="ECommonServiceClass" />
        /// </summary>
        public string Clazz => this.Get_clazz();
