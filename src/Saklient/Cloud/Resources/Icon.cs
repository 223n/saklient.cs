...
namespace Saklient.Cloud.Resources
{
    ...
    public class Icon : Resource
    {
        ...
        public override string _ClassName() => "Icon";
        ...
        /// </summary>
        public Icon Save() => ((Icon)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Icon Reload() => ((Icon)(this._Reload()));
        ...
        private string Get_url() => this.M_url;

        /// <summary>URL
        /// </summary>
        public string Url => this.Get_url();
