...
namespace Saklient.Cloud.Resources
{
	...
	public class RouterActivity : Activity
	{
        ...
        internal System.Collections.Generic.List<RouterActivitySample> Get_samples() => this._Samples;

        /// <summary>サンプル列
        /// </summary>
        public System.Collections.Generic.List<RouterActivitySample> Samples => this.Get_samples();

        internal override string _ApiPathPrefix() => "/internet";
        ...
        internal override void _AddSample(string atStr, object data) => (this._Samples as System.Collections.IList).Add(new RouterActivitySample(atStr, data));
