...
namespace Saklient.Cloud.Resources
{
    ...
    public class LbVirtualIp
    {
        ...
        public string Get_virtualIpAddress() => this._VirtualIpAddress;
        ...
        public long? Get_delayLoop() => this._DelayLoop;
        ...
        public System.Collections.Generic.List<LbServer> Get_servers() => this._Servers;

        /// <summary>実サーバ <see cref="Saklient.Cloud.Resources.LbServer" /> の配列
        /// </summary>
        public System.Collections.Generic.List<LbServer> Servers => this.Get_servers();
        ...
        public LbServer GetServerByAddress(string address)
        {
            for (int __it1 = 0; __it1 < (this._Servers as System.Collections.IList).Count; __it1++)
            {
                ...
                if (srv.IpAddress == address) return srv;
            }
            return null;
        }
        ...
        public LbVirtualIp RemoveServerByAddress(string address)
        {
            ...
            {
                var srv = this._Servers[__it1];
                if (srv.IpAddress != address) (servers as System.Collections.IList).Add(srv);
            }
