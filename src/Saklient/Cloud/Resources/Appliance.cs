...
namespace Saklient.Cloud.Resources
{
    ...
    public class Appliance : Resource
    {
        ...
        public override string _ClassName() => "Appliance";

        public override string _Id() => this.Get_id();

        /// <summary>このローカルオブジェクトに現在設定されているリソース情報をAPIに送信し、新規作成または上書き保存します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Appliance Save() => ((Appliance)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Appliance Reload() => ((Appliance)(this._Reload()));
        ...
        internal override void _OnBeforeSave(object query) => Util.SetByPath(query, "OriginalSettingsHash", this.Get_rawSettingsHash());
        ...
        /// <param name="timeoutSec" />
        /// </summary>
        public bool SleepUntilUp(long timeoutSec = 600) => this.SleepUntil(EServerInstanceStatus.UP, timeoutSec);
        ...
        /// <returns>成功時はtrue、タイムアウトやエラーによる失敗時はfalseを返します。</returns>
        /// </summary>
        public bool SleepUntilDown(long timeoutSec = 600) => this.SleepUntil(EServerInstanceStatus.DOWN, timeoutSec);
        ...
        private string Get_id() => this.M_id;
        ...
        private string Get_clazz() => this.M_clazz;

        private string Set_clazz(string v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Appliance#Set_clazz");
            this.M_clazz = v;
            this.N_clazz = true;
            return this.M_clazz;
        }
        ...
        private string Get_name() => this.M_name;
        ...
        private string Get_description() => this.M_description;
        ...
        private Icon Get_icon() => this.M_icon;
        ...
        private long? Get_planId() => this.M_planId;

        private long? Set_planId(long? v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Appliance#Set_planId");
            this.M_planId = v;
            this.N_planId = true;
        ...
        private System.Collections.Generic.List<Iface> Get_ifaces() => this.M_ifaces;

        /// <summary>インタフェース <see cref="Saklient.Cloud.Resources.Iface" /> の配列
        /// </summary>
        public System.Collections.Generic.List<Iface> Ifaces => this.Get_ifaces();

        private bool N_rawAnnotation = false;

        private object Get_rawAnnotation() => this.M_rawAnnotation;

        private object Set_rawAnnotation(object v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Appliance#Set_rawAnnotation");
        ...
        private string Get_rawSettingsHash() => this.M_rawSettingsHash;

        public string RawSettingsHash => this.Get_rawSettingsHash();

        private bool N_status = false;

        private string Get_status() => this.M_status;

        /// <summary>起動状態 <see cref="Saklient.Cloud.Enums.EServerInstanceStatus" />
        /// </summary>
        public string Status => this.Get_status();

        private bool N_serviceClass = false;

        private string Get_serviceClass() => this.M_serviceClass;

        /// <summary>サービスクラス
        /// </summary>
        public string ServiceClass => this.Get_serviceClass();

        private bool N_availability = false;

        private string Get_availability() => this.M_availability;

        /// <summary>有効状態 <see cref="Saklient.Cloud.Enums.EAvailability" />
        /// </summary>
        public string Availability => this.Get_availability();

        private bool N_swytchId = false;

        private string Get_swytchId() => this.M_swytchId;

        /// <summary>接続先スイッチID
        /// </summary>
        public string SwytchId => this.Get_swytchId();
        ...
        {
            this.IsNew = r == null;
            if (this.IsNew) r = new System.Collections.Generic.Dictionary<string, object> { };
