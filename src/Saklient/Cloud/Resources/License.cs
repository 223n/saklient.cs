...
namespace Saklient.Cloud.Resources
{
    ...
    public class License : Resource
    {
        ...
        public override string _ClassName() => "License";
        ...
        /// </summary>
        public License Save() => ((License)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public License Reload() => ((License)(this._Reload()));
        ...
        private LicenseInfo Get_info() => this.M_info;

        private LicenseInfo Set_info(LicenseInfo v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.License#Set_info");
            this.M_info = v;
            this.N_info = true;
            return this.M_info;
        }
