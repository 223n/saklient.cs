...
namespace Saklient.Cloud.Resources
{
    ...
    public class Iface : Resource
    {
        ...
        internal override string _ApiPath() => "/interface";

        internal override string _RootKey() => "Interface";

        internal override string _RootKeyM() => "Interfaces";

        public override string _ClassName() => "Iface";
        ...
        /// </summary>
        public Iface Save() => ((Iface)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Iface Reload() => ((Iface)(this._Reload()));

        internal IfaceActivity _Activity;

        public IfaceActivity Get_activity() => this._Activity;

        /// <summary>アクティビティ
        /// </summary>
        public IfaceActivity Activity => this.Get_activity();
        ...
        private string Get_macAddress() => this.M_macAddress;

        /// <summary>MACアドレス
        /// </summary>
        public string MacAddress => this.Get_macAddress();

        private bool N_ipAddress = false;

        private string Get_ipAddress() => this.M_ipAddress;

        /// <summary>IPv4アドレス（共有セグメントによる自動割当）
        /// </summary>
        public string IpAddress => this.Get_ipAddress();

        private bool N_userIpAddress = false;

        private string Get_userIpAddress() => this.M_userIpAddress;
        ...
        private string Get_serverId() => this.M_serverId;
