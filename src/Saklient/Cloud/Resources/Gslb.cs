...
namespace Saklient.Cloud.Resources
{
    ...
    public class Gslb : CommonServiceItem
    {
        ...
        public System.Collections.Generic.List<GslbServer> Get_servers() => this._Servers;

        /// <summary>仮想IPアドレス <see cref="Saklient.Cloud.Resources.GslbServer" /> の配列
        /// </summary>
        public System.Collections.Generic.List<GslbServer> Servers => this.Get_servers();
        ...
        {
            if (!Util.ExistsPath(this.RawSettings, "GSLB.HealthCheck.Path")) return null;
        ...
        public long Get_responseExpected()
        {
            ...
            if (raw == null) throw new SaklientException("invalid_data", "Data of the resource is invalid");
        ...
        public long Get_delayLoop()
        {
            ...
            if (delayLoop == null) throw new SaklientException("invalid_data", "Data of the resource is invalid");
        ...
        public bool Get_weighted()
        {
            ...
            if (weighted == null) throw new SaklientException("invalid_data", "Data of the resource is invalid");
