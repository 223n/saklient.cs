...
namespace Saklient.Cloud.Resources
{
	...
	public class ServerActivity : Activity
	{
        ...
        internal System.Collections.Generic.List<ServerActivitySample> Get_samples() => this._Samples;

        /// <summary>サンプル列
        /// </summary>
        public System.Collections.Generic.List<ServerActivitySample> Samples => this.Get_samples();

        internal override string _ApiPathPrefix() => "/server";
        ...
        internal override void _AddSample(string atStr, object data) => (this._Samples as System.Collections.IList).Add(new ServerActivitySample(atStr, data));
