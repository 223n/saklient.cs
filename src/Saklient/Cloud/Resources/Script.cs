...
namespace Saklient.Cloud.Resources
{
    ...
    public class Script : Resource
    {
        ...
        public override string _ClassName() => "Script";
        ...
        /// </summary>
        public Script Save() => ((Script)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Script Reload() => ((Script)(this._Reload()));
        ...
        private string Get_content() => this.M_content;
        ...
        private object Get_annotation() => this.M_annotation;

        /// <summary>注釈
        /// </summary>
        public object Annotation => this.Get_annotation();
