...
namespace Saklient.Cloud.Resources
{
    ...
    public class Router : Resource
    {
        ...
        public override string _ClassName() => "Router";
        ...
        /// </summary>
        public Router Save() => ((Router)(this._Save()));

        /// <summary>最新のリソース情報を再取得します。
        /// 
        /// <returns>this</returns>
        /// </summary>
        public Router Reload() => ((Router)(this._Reload()));

        internal RouterActivity _Activity;

        public RouterActivity Get_activity() => this._Activity;

        /// <summary>アクティビティ
        /// </summary>
        public RouterActivity Activity => this.Get_activity();
        ...
        private long? Get_networkMaskLen() => this.M_networkMaskLen;

        private long? Set_networkMaskLen(long? v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Router#Set_networkMaskLen");
        ...
        private long? Get_bandWidthMbps() => this.M_bandWidthMbps;

        private long? Set_bandWidthMbps(long? v)
        {
            if (!this.IsNew) throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resources.Router#Set_bandWidthMbps");
