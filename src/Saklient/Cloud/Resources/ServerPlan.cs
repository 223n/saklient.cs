...
namespace Saklient.Cloud.Resources
{
    ...
    public class ServerPlan : Resource
    {
        ...
        public override string _ClassName() => "ServerPlan";
        ...
        public long? MemoryGib => this.Get_memoryGib();
        ...
        private long? Get_cpu() => this.M_cpu;

        /// <summary>仮想コア数
        /// </summary>
        public long? Cpu => this.Get_cpu();

        private bool N_memoryMib = false;

        private long? Get_memoryMib() => this.M_memoryMib;

        /// <summary>メモリ容量[MiB]
        /// </summary>
        public long? MemoryMib => this.Get_memoryMib();
