...
namespace Saklient.Cloud.Resources
{
    ...
    public class Resource
    {
        ...
        public void SetParam(string key, object value) => (this._Query as System.Collections.Generic.Dictionary<string, object>)[key] = value;
        ...
        public virtual string _ClassName() => null;

        public virtual string _Id() => null;
        ...
        internal virtual object ApiSerializeImpl(bool withClean = false) => null;
        ...
        internal string NormalizeFieldName(string name) => name.Substring(0, 1).ToUpper() + name.Substring(1);
        ...
        public object Dump() => this.ApiSerialize(true);
