...
namespace Saklient.Cloud.Resources
{
    ...
    public class LoadBalancer : Appliance
    {
        ...
        public System.Collections.Generic.List<LbVirtualIp> Get_virtualIps() => this._VirtualIps;

        /// <summary>仮想IPアドレス <see cref="Saklient.Cloud.Resources.LbVirtualIp" /> の配列
        /// </summary>
        public System.Collections.Generic.List<LbVirtualIp> VirtualIps => this.Get_virtualIps();

        public string Get_defaultRoute() => ((string)(Util.GetByPath(this.RawAnnotation, "Network.DefaultRoute")));
        ...
        public long Get_maskLen()
        {
            ...
            if (maskLen == null) throw new SaklientException("invalid_data", "Data of the resource is invalid");
        ...
        public long Get_vrid()
        {
            ...
            if (vrid == null) throw new SaklientException("invalid_data", "Data of the resource is invalid");
        ...
        {
            /*!base!*/
            if (this.RawAnnotation == null) this.RawAnnotation = new System.Collections.Generic.Dictionary<string, object> { };
        }
        ...
        {
            while (0 < this._VirtualIps.Count) Util.Pop(this._VirtualIps);
            return this;
        }
        ...
        public LbVirtualIp GetVirtualIpByAddress(string address)
        {
            ...
            {
                var vip = this._VirtualIps[__it1];
                if (vip.VirtualIpAddress == address) return vip;
            }
            return null;
        }
