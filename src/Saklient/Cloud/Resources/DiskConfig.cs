...
namespace Saklient.Cloud.Resources
{
    ...
    public class DiskConfig
    {
        ...
        internal string Get_diskId() => this._DiskId;

        public string DiskId => this.Get_diskId();

        internal string _HostName;

        internal string Get_hostName() => this._HostName;
        ...
        internal string Get_password() => this._Password;
        ...
        internal System.Collections.Generic.List<string> Get_sshKeys() => this._SshKeys;

        internal string Get_sshKey()
        {
            if (this._SshKeys.Count < 1) return null;
        ...
        /// <summary>SSHキー
        /// </summary>
        public System.Collections.Generic.List<string> SshKeys => this.Get_sshKeys();

        internal string _IpAddress;

        internal string Get_ipAddress() => this._IpAddress;
        ...
        internal string Get_defaultRoute() => this._DefaultRoute;
        ...
        internal long? Get_networkMaskLen() => this._NetworkMaskLen;
        ...
        internal System.Collections.Generic.List<Script> Get_scripts() => this._Scripts;

        /// <summary>スタートアップスクリプト <see cref="Saklient.Cloud.Resources.Script" /> の配列（pushによりスクリプトを追加できます）
        /// </summary>
        public System.Collections.Generic.List<Script> Scripts => this.Get_scripts();
